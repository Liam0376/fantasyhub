import{k as ee,h as l,r as te,p as P,i as q,j as fe,t as se,J as $e,N as be}from"./index-C6_NqDZT.js";async function ke(m){const U=new URLSearchParams(location.hash.split("?")[1]||"");let re=U.get("team_a")||"1",ae=U.get("team_b")||"2";m.innerHTML=`
