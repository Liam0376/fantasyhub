import{d as R,I as C,J as N,g as E,e as o,K as q,p as y,o as x,m as z,t as b,j as S}from"./index-B-4KdT_p.js";import{g as W,s as H,r as O,b as U}from"./teamSelector-DzJVhgid.js";const M=["QB","RB","WR","TE","K","DEF"],k={improvement_desc:{label:"Δ roster: high to low",cmp:(a,t)=>(t.improvement_over_roster??-1/0)-(a.improvement_over_roster??-1/0)},points_desc:{label:"Proj points: high to low",cmp:(a,t)=>(t.projected_points??-1/0)-(a.projected_points??-1/0)},points_asc:{label:"Proj points: low to high",cmp:(a,t)=>(a.projected_points??1/0)-(t.projected_points??1/0)}};function L(a){return a.length?`
  ...
  `,U(()=>J(a)),(u=a.querySelector("#waiverPosFilter"))==null||u.addEventListener("change",e=>{n.pos=e.target.value,v()}),(w=a.querySelector("#waiverTeamFilter"))==null||w.addEventListener("change",e=>{n.team=e.target.value,v()}),(_=a.querySelector("#waiverSort"))==null||_.addEventListener("change",e=>{n.sort=e.target.value,v()}),h(s),a.querySelectorAll("[data-trending-pid]").forEach(e=>{e.addEventListener("click",()=>{const i=e.getAttribute("data-trending-pid"),r=p.find(m=>String(m.player_id)===String(i));r&&x({player_id:r.player_id,player_name:r.player_name||"",position:r.position||"",team:r.team||""},a)})})}export{J as renderWaiver};
