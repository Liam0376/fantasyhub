import{h as m,M as u,H as g}from"./index-C2mMjaKG.js";function o(e){return u(g())}function f(e){try{return localStorage.getItem(o(e))||null}catch{return null}}function S(e,a){try{localStorage.setItem(o(a),String(e))}catch{}}function b(e=[],a=null){var r;const t=Array.isArray(e)&&e.length?e:[];if(!t.length)return'<div class="faint" style="font-size:12px">No teams synced — <a href="#dashboard">open Dashboard</a> to set up your league.</div>';const n=t.length&&((r=t[0])==null?void 0:r.roster_id)!=null?String(t[0].roster_id):null,c=a||f()||n;return`
